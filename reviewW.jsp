		...
		<%@ page trimDirectiveWhitespaces="true" %>
			...
			<div><img class="banner-image" src="images/banner2.png"></div>
				...
				<table>
					<tr>
						<th>상품선택</th>
						<td colspan="6"><input id="product-name" type="text" readonly value="상품1"> <button id="product-choice" onclick="window.open('reviewProductChoice','','width=600, height=450')"  >상품선택</button>                                                               

...
<h2>회원정보상세</h2>
	...
	<form action="aMemberV">
		<div id="first-div">
			<label>아이디</label><br>
			<input id="id" value="${dto.member_id }" readonly style="border:none">
		</div>
		<button id="orderBtn" type="button">최근주문내역보기</button><br>
		<label>비밀번호</label><br>
		<input value="${dto.member_pw }" type="text"><br>
		<label>이름</label><br>
		<input value="${dto.member_name }" type="text"><br>
		<label>생년월일</label><br>
		<div id="birth">
	...
	<button type="button" onclick="sample4_execDaumPostcode()" >우편번호찾기</button><br>

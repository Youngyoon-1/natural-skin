...
<body>
	...
	<div class="main">
		<div class="recipient">
			<div><input id="checkBox" type="checkbox">주문자 정보와 동일</div>
	...
	<table class="payment">
		<tr>
			<th>결제방법 선택</th>
			<td>
				<input class="radio" type="radio" name="radio" />무통장입금&nbsp;&nbsp;
				<input  class="radio" type="radio" name="radio" />신용카드&nbsp;&nbsp;
				<input  class="radio" type="radio" name="radio" />핸드폰결제
			</td>
		</tr>
		<tr>
			<th>배송비</th>

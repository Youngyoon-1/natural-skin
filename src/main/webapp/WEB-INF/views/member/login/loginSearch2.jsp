  ...
  <img id="login" src="images/login-top.png" width="100%">
    ...
    <form action="searchPw" method="post">
	    <div class="searchIdDiv">
	    	...
	    	<div id="radioDiv">
	    		<span>찾을수단</span><input type="radio" name="findBy" value="member_email" onclick="showMailInput();" checked><label>이메일</label><input type="radio" name="findBy" value="member_phone" onclick="showPhoneInput();"><label>휴대폰번호</label>
	    	</div>
	    	<div>
	    		<label>아이디</label><input name="member_id" class="input" type="text">
	    	</div>
	    	<div>
